...
export class AuthService {
  ...
  login(user?: string) {
    if (user) console.log(`[AuthService] Logged in: ${user}`);
  ...
  private async exchangeCodeForToken(code: string): Promise<TokenResponse> {
    ...
    const body = new URLSearchParams({ grant_type: 'authorization_code', code, redirect_uri: this.REDIRECT_URI, client_id: this.CLIENT_ID });
